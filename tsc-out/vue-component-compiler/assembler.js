System.register(["source-map", "./source-map", "path"], function (exports_1, context_1) {
    "use strict";
    var source_map_1, source_map_2, path;
    ...
    function assembleFromSource(compiler, options, { filename, script, template, styles, scopeId }) {
        ...
        let map = undefined;
        const mapGenerator = new source_map_1.SourceMapGenerator({ file: filename.replace(/\\/g, '/') });
  ...
  export default __vue_component__`;
    ...
    exports_1("assembleFromSource", assembleFromSource);
    return {
        setters: [
            function (source_map_1_1) {
                source_map_1 = source_map_1_1;
            },
            function (source_map_2_1) {
                source_map_2 = source_map_2_1;
            },
            function (path_1) {
                path = path_1;
            }
